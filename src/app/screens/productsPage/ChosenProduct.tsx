      ...
      <Container className={"product-container"}>
        ...
        <Stack className={"chosen-product-info"}>
          <Box className={"info-box"}>
            ...
            <p className={"product-desc"}>{chosenProduct?.productDesc ? chosenProduct?.productDesc : "No Descripton"}</p>
            ...
            <div className={"button-box"}>
              ...
              onClick={(e) => {
                ...
                onAdd  ({
                  ...
                  quantity: 1,
                  name: chosenProduct?.productName as string,
                  price: chosenProduct?.productPrice as number,
                  image: chosenProduct?.productImages[0] as string,
              });
                e.stopPropagation();
              }}
